...
O bot opera em um ciclo contínuo: **Leitura de Preço → Análise → Sinal → Execução → Notificação**.
...
| **Cérebro de Trade** | `src/trade_brain.py` | Médias Móveis, RSI, Regressão Linear, geração de sinais |
